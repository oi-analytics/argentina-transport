    ...
    for m in range(len(modes)):
        ...
        for perct in percentage:
            ...
            for t in range(len(types)):
                ...
                if single_edge == True:
                    file_name = 'single_edge_failures_all_{0}_{1}_{2}_percent_disrupt_multi_modal.csv'.format(modes[m]['sector'], types[t],int(perct))
                else:
                ...
                if single_edge == True:
                    file_name = 'single_edge_failures_od_losses_{0}_{1}_{2}_percent_disrupt_multi_modal.csv'.format(modes[m]['sector'], types[t],int(perct))
                else:
                ...
                if single_edge == True:
                    file_name = 'single_edge_failures_rerout_losses_{0}_{1}_{2}_percent_disrupt_multi_modal.csv'.format(modes[m]['sector'], types[t],int(perct))
                else:
            ...
            if single_edge == True:
                file_name = 'single_edge_failures_minmax_{0}_{1}_percent_disrupt_multi_modal'.format(modes[m]['sector'],int(perct))
            else:
