...
project = u'Argentina Transport Risk Analysis'
copyright = u'2018, Oxford Infrastructure Analytics'
...
htmlhelp_basename = 'argentina-transport-doc'
...
latex_documents = [
    ('index', 'user_guide.tex', u'Argentina Transport Risk Analysis Documentation',
     u'Oxford Infrastructure Analytics', 'manual'),
]
