...
def main():
    ...
    for mode in modes:
        ...
        all_edge_fail_scenarios = all_edge_fail_scenarios[hazard_cols + ['department_id','probability','length','total_length']]
        all_edge_fail_scenarios = all_edge_fail_scenarios.groupby(hazard_cols + ['department_id','probability'])['length','total_length'].sum().reset_index()
