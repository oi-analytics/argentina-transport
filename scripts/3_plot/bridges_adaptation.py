...
def main():
    ...
    #         # title = 'Bridges ({}) {} {}'.format(adapt_set[c]['title'],climate_scenario.replace('_',' ').title(),year)
    ...
    #         #     config['paths']['figures'], 'national-bridges-{}-{}-{}-{}-days.png'.format(climate_scenario.replace('.',''),year,adapt_set[c]['column'],duration))
